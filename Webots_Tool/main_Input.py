...
def get_isSet_Choice() :
    """_Gets choice between generating a set of Webots World or juste a single Webots World_

    Returns:
        c (_int_): _Correspond to the selected choice_
    """
    print("Welcome to this Tool. How many Webots World do you want to generate ? ")
    print(" 1 - A set of Webots World ")
    print(" 2 - A single Webots World ")
    c = input("Choice (int) : ")
    isOK = False 
    while isOK == False : 
